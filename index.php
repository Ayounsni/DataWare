<?php
include "connect.php";
$query = "SELECT * FROM membre_personnel JOIN Equipes ON membre_personnel.ID_Equipe = Equipes.ID_Equipe;";
...
<body>
    ...
    <div> <h1 class="text-center">Tableau <a href="#">Membres & Equipes</a> / <a href="Members.php">Membres</a> / <a href="Equipes.php">Equipes</a>  </h1></div>
